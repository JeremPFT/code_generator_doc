...
\begin{tikzpicture}[ every annotation/.style = {draw,
  ...
  \path[mindmap,concept color=black!40,text=white,
    ...
    root/.style    = {concept color=black!40,
      font=\large\bfseries,text width=15em},
    %
  ...
  child[concept color=blue!60] {
    node {format d'entrée}
    %
    [clockwise from=90]
    %
    child { node (specAsCode) {sous-\\programmes} }
    %
    child { node (specAsText) {par texte : définition d'une syntaxe} }
  }
  %
  ...
  %
  \info{specAsCode.north east}{above,anchor=west,xshift=1em}{%
  \item[] Seit 2008
  ...
  %
  \info[15]{specAsText.south}{below,anchor=north,xshift=3em}{%
